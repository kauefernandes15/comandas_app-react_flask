    ...
    return (
        <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ backgroundColor: '#ADD8E6', padding: 1, borderRadius: 1, mt: 2 }}>
            ...
            <Box sx={{ backgroundColor: 'white', padding: 2, borderRadius: 3, mb: 2 }}>
                <TextField
                    label="Usuário" fullWidth margin="normal" {...register('usuario', { required: 'Usuário é obrigatório', maxLength: { value: 11, message: "Máximo 11 caracteres" } })} error={!!errors.usuario} helperText={errors.usuario?.message}
                />
                <TextField
